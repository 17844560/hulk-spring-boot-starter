...
object ChineseName {
    ...
    val chinese: String
        get() {
            ...
            try {
                str = String(bArr, Charsets.UTF_8)
    ...
    fun randomName(): String {
        ...
        val name = Surname[index] //获得一个随机的姓氏

        /* 从常用字中选取一个或两个字作为名 */
        var added = if (random.nextBoolean()) {
            chinese + chinese
        } else {
            chinese
        }
